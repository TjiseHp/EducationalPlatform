...
<div align="center" style="padding-top: 50px;">
	...
	<form >
		...
		<label class="control-label col-lg-3" for="name"><span>发件人：</span></label>
			<div class="col-md-7">
			<input class="form-control" type="text" value="${chat.user1.uName}&nbsp;${chat.user1.uEmail}">${chat.user1.uName}&nbsp;${chat.user1.uEmail}
			</div>
		</div>
		
		<div class="row form-group">
		<label class="control-label col-lg-3" for="name"><span>时间：</span></label>
			<div class="col-md-7">
			<input class="form-control" type="text" value="${chat.chatDate}">${chat.chatDate}
			</div>
		</div>
		...
		<label class="control-label col-lg-3" for="name"><span>收件人：</span></label>
			<div class="col-md-7">
			<input class="form-control" type="text" value="${chat.user2.uName}&nbsp;${chat.user2.uEmail}">${chat.user2.uName}&nbsp;${chat.user2.uEmail}
			</div>
		</div>
		
		<div class="row form-group">
			<label class="control-label col-lg-3" for="name"><span>请输入内容：</span></label>
			<div class="col-md-7">
			<input class="form-control" type="text" value="${chat.chatText}">${chat.chatText}
			</div>
		</div>
