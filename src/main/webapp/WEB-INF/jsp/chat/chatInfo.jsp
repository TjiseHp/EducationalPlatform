...
<div align="center" style="padding-top: 50px;">
	...
	<form action="${pageContext.request.contextPath}/user/doInsertChatInfo" method="post" accept-charset="utf-8" onsubmit="return doPost()">
		...
		<div class="row form-group">
			...
			<div class="col-md-7">
			<input class="form-control" type="text" id="uId" name="uId" value="${chat.user1.uId}">
			</div>
		</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-7">
			<input class="form-control" type="text" id="chatText" name="chatText">
			</div>
		</div>
