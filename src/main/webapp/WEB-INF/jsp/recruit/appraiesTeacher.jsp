...
<div align="center" style="padding-top: 50px;">
	...
	<form action="${pageContext.request.contextPath}/appraise/appraiseTeacher" method="post" accept-charset="utf-8" onsubmit="return doUpdate()">
			...
			<label class="control-label col-lg-3" for="name"><span>教师姓名：</span></label>
				<div class="col-md-7">
			...
			<div class="row form-group">
			<label class="control-label col-lg-3" for="name"><span>评价：</span></label>
				<div class="col-md-7">
			...
			<div class="row form-group">
			<label class="control-label col-lg-3" for="name"><span>评分：</span></label>
				<div class="col-md-7" style="margin-top:11px;margin-left:-40px">
