...
.suspensionleft{width:20%;height:100%;background:url("${pageContext.request.contextPath}/plug/img/t/tt3.jpg") no-repeat;
padding-top:100px;position:absolute;left:2%;top:50%;}
.suspensionright{width:20%;height:100%;background:url("${pageContext.request.contextPath}/plug/img/t/tt4.jpg") no-repeat;
