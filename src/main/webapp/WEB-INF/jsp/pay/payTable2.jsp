	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
	        $('#table1').bootstrapTable({
	            url: '${pageContext.request.contextPath}/pay/queryAllPay',
	            method: 'post', 
	            columns: [
	                {
	                    sortable: "true",
		...
		window.operateEvents1 = {
	        "click .deleteBtn": function (e, value, row, index) {
	        	...
	        	layer.confirm('确认删除？', {
					...
					$.ajax({
	                    type: "post",
	                    url: "${pageContext.request.contextPath}/pay/deletePay2",
	                    data: {
	                    	"payNum": payNum
                  			},
                  			beforeSend : function(){
	        ...
	        "click .updateBtn": function (e, value, row, index) {
	        	window.location.href = "${pageContext.request.contextPath}/pay/updatePay?payNum="+payNum;
	        }
	    }
